...
ScrollViewProps::ScrollViewProps(const ScrollViewProps &sourceProps, const RawProps &rawProps):
  ...
  pagingInterval(convertRawProp(rawProps, "pagingInterval", sourceProps.pagingInterval)),
...
SharedDebugStringConvertibleList ScrollViewProps::getDebugProps() const {
  ...
  return
    ...
    SharedDebugStringConvertibleList {
      ...
      debugStringConvertibleItem("pagingInterval", pagingInterval, defaultScrollViewProps.pagingInterval),
